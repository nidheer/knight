...
/*
                ...
                */
                ...
                if ($currentAmount < $amount) {
                  echo '<div class="col-lg-4">';
                  echo '  <div class="portfolio-info">';
                  echo "Insufficient balance. Please add funds to your account before making the payment. <br> ";
              
                  echo '</div>';
                 // die("Insufficient balance. Please add funds to your account before making the payment.");
                } else {
                    ...
                    if ($result3->num_rows === 0) {
                        ...
                        die("Merchant ID does not exist. Please retry entering a correct <a href=\"pay.html\">Merchant ID</a>.");
                        echo '</div>';
                    }
                    ...
                    if ($stmt4->affected_rows === 0) {
                        ...
                        echo '  <div class="portfolio-info">';
                        echo '<div class="error-message">';
                        die("Failed to update the sales table.");
                        echo '</div>';
                    }
