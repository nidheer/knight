      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-8">
            ...
            // Query the database to check if the ID and CVV exist in the table
            $query = "SELECT amount FROM cards WHERE uid = '$id' AND cvv = '$cvv'";
            ...
            if ($result->num_rows > 0) {
                ...
                if ($accountBalance >= $amount) {
                    ...
                    $updateQuery = "UPDATE cards SET amount = '$newBalance' WHERE uid = '$id' AND cvv = '$cvv'";
                    $updateResult = $conn->query($updateQuery);

                    // Update the accountbal table with the deducted amount
                    $accountUpdateQuery = "UPDATE accountbal SET amount = amount +'$amount' WHERE uid = '$id'";
                    $accountUpdateResult = $conn->query($accountUpdateQuery);

                    if ($updateResult && $accountUpdateResult) {
                        ...
                        you can check your Account Balance <a href=\"account.html\">here</a>. ";
                  ...
                  echo '  <div class="portfolio-info">';
                  echo '<div class="error-message">';
                    echo "Insufficient funds on your card.<br><br> Please ensure that you have enough credit on your card to continue <br> <br>
                    You can proceed by adding another card <br> <a href=\"add.html\">here</a>. ";
              ...
              echo '  <div class="portfolio-info">';
              echo '<div class="error-message">';
                echo "Invalid ID and/or CVV. <br> Please Enter the correct details <br> <a href=\"topup.html\">here</a>. ";
                echo '</div>';
            }
