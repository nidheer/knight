...
include('db1.php');
                ...
                // Validate inputs (you can add additional validation if needed)
                if (empty($uid) || empty($merchantId) || empty($amount)) {
                ...
                die("UID not found .Please re try entering a correct <a href=\"pay.html\">UID</a>.");
                }
                ...
                echo "Merchant ID: $merchantId, <br>  UID: $uid, <br> Amount: $amount.";
                echo '</div>';
