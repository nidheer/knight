...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($result->num_rows > 0) {
        // Display the gift card information
        echo '<div class="col-lg-4">';
        echo '  <div class="portfolio-info">';
        echo "<h2>Gift Card Information</h2>";
        echo "Hi! You have the following gift cards available:<br>";
    
        while ($row = $result->fetch_assoc()) {
            echo "<p><strong>Code:</strong> " . $row["code"] . "</p>";
      ...
      echo '<div class="col-lg-4">';
      echo '  <div class="portfolio-info">';
      echo "<p>No gift cards found with the given UID.</p>";
      echo '</div>';
      echo '</div>';
    }
